const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 2.04C6.47 2.04 2 6.51 2 12.04C2 16.98 5.67 21.06 10.44 21.88V14.68H7.9V12.04H10.44V9.89C10.44 7.39 11.93 6.03 14.17 6.03C15.19 6.03 16.27 6.22 16.27 6.22V8.7H15C13.75 8.7 13.56 9.43 13.56 10.24V12.04H16.15L15.73 14.68H13.56V21.88C18.33 21.06 22 16.98 22 12.04C22 6.51 17.53 2.04 12 2.04Z"
          fill="currentColor"
        />
      </svg>
    ),
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch]">
            Contact me with Collaboration
          </h2>
          <p className="text-zinc-400  mt-10 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Please don't hesitate to contact me with any questions or concerns.
            I'm always open to considering work opportunities that align with my
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                target="_blank"
                key={key}
                className="w-12 h-12 grid place-content-center ring-inset ring-2 ring-zinc-50/50 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/axojqxjb"
          method="POST"
        ...
        >
          <div className="md-grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="Tahaghous@email.com"
                className="text-field"
              />
            </div>
          </div>
          ...
          <div className="">
            ...
            <textarea
              name="message"
              id="message"
              className="text-field resize-y min-h-32 mb-4 max-h-80"
